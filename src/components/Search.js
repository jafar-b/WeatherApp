...
import sunrise1 from "../sunrise1.png";
import sunset1 from "../sunset.png";
    ...
    <div className="container">
      ...
      <div className="weatherinfo">
        <div className="tempwind"> 
          ...
          <img src= {celsius} height={30} width={30}/>  Temperature  :<h1>{temp
            }°C</h1> 
          </div> 
          <div className="wind">
          <img src= {winddirection} height={30} width={30}/> &nbsp; Wind :<h2>{wind} mph</h2></div>
        </div> 
       {(weather!=null )&&
           ...
           <span style={{ margin: "1rem" }}> <h5>{weather}</h5></span>
        ...
        <img src= {station} height={40} width={40}/>⛅ &nbsp; Weather in <h1>{name} </h1>
